...
This is the current milestone of the larger the university badminton research project. It follows the phone/OpenCap-style capture direction from `research-direction-image-to-sim.md` and the pipeline/schema in `badminton_camera_research.md` (§6).
